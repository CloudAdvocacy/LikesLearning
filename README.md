...
To run the sample, you would need to run Jupyter Notebook [`LikesLearning.ipynb`](LikesLearning.ipynb). The best way to do that is via [Visual Studio CodeSpaces](http://aka.ms/codespaces), where you can easily create an online environment that will run the code. You may also use other tools, such as [Binder](http://mybinder.org/).

<a href="https://mybinder.org/v2/gh/CloudAdvocacy/LikesLearning/master"><img src="https://mybinder.org/badge_logo.svg"/></a>
<a href="https://notebooks.azure.com/import/gh/CloudAdvocacy/LikesLearning"><img src="https://notebooks.azure.com/launch.png" /></a>
